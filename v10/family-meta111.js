...
function signalPersist(){if(typeof document==='undefined')return;const carrier=document.querySelector('[data-adaptive-zone] [data-family-field]');if(carrier)carrier.dispatchEvent(new Event('input',{bubbles:true}))}

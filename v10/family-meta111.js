...
const DEFINITIONS111={
 ...
 'تحليل نتائج':[
  ...
  {id:'assessmentType',label:'نوع الاختبار',q:'ما نوع الاختبار أو أداة التقويم؟',type:'choice',opts:['اختبار تشخيصي','اختبار الفترة الأولى','اختبار الفترة الثانية','اختبار قبلي','اختبار بعدي','اختبار نهائي','تقويم تكويني','تقويم مستمر','اختبار وطني أو مركزي']}
 ],
 'خطة':[
...
const meta=s=>{s.metadata=s.metadata||{};s.metadata.familyMeta111=s.metadata.familyMeta111||{};s.metadata.familyMeta111Skipped=s.metadata.familyMeta111Skipped||[];const m=s.metadata.familyMeta111;if(s.classification?.type==='تحليل نتائج'&&!m.expectedCount&&s.metadata.count&&s.metadata.countSource101!=='derived'&&!s.metadata.familyMeta111Skipped.includes('expectedCount'))m.expectedCount=String(s.metadata.count);return m};
...
let current=null;
export function bindFamilyMeta111(state){current=state;syncDerived111()}

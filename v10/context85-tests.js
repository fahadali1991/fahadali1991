...
const cases=[
 ...
 ['خطة علاجية بعد مراجعة الدرجات','شفنا الدرجات وبعدها سوينا خطة علاجية للطلاب المحتاجين للدعم',{type:'خطة',basis:'نتائج تقويم أو اختبارات',goal:'معالجة فجوة محددة'}],

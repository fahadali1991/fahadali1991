...
for(const [file,needle] of [
 ...
 ['v10/family-details68.js','./family-details109.js?v=113'],
...
console.log(`Production cache chain PASS: shell token ${token}; V113 recovery edges are explicit while unchanged modules remain pinned.`);

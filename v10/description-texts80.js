...
function core(s,level='medium'){
 ...
 if(x.t==='برنامج / فعالية'){
   ...
   a.push(`عُقد ${x.title} بمشاركة ${x.a}.`);
   ...
   a.push(`أُجري ${x.title} لخدمة ${x.a}.`);
   ...
   a.push(`أُعدت ${x.title} لخدمة ${x.a}.`);
   ...
   a.push(`نُفذ ${x.title} بما يخدم ${x.a}.`);
 ...
 }else a.push(`تم تنفيذ ${x.title} لصالح ${x.a}.`);
 return c(a.join(' '));
}

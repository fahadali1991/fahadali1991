...
import {analysisOutputPanel132,bindAnalysisOutput132} from './analysis-output132-release.js?v=132';
...
export function finalDocument76(s){
 ...
 if(isAnalysis){
  bindAnalysisOutput132(s);
  return analysisFinalPanel133(s)+analysisOutputPanel132(s)+`<div class="row" style="position:static;margin:0 0 48px"><button class="btn primary" data-action="new-document">إنشاء تحليل جديد</button></div>`;
 }

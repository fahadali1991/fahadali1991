...
export function analysisPlansPanel131(state){
 ...
 return`<section class="card analysisPlans131"><div class="muted">الخطط التعليمية</div><h2>لا توجد خطة آلية دون مستوى إتقان مستهدف</h2><p class="questionHelp">تم تحليل الدرجات كميًا فقط. لم يحدد مستوى الإتقان المستهدف لهذا الاختبار، لذلك لا يحدد النظام طلابًا للعلاج أو الإثراء من تلقاء نفسه.</p><div class="planGuard131"><b>لماذا؟</b><span>الدرجة الكلية وحدها لا تكفي للحكم على إتقان ناتج تعلم أو لتشخيص مهارة ضعيفة. يمكنك تعديل بيانات الاختبار وتحديد مستوى إتقان مستهدف، أو إنشاء خطة مستقلة بطلاب تحددهم أنت.</span></div></section>`;
}

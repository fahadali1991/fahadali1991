...
function forceDirectEntry134(s,entryIntent){
 ...
 if(entryIntent==='remedial'){if(core.setType)core.setType(s,'خطة');if(core.setSubtype)core.setSubtype(s,'خطة علاجية');s.metadata.directEntry134='remedial';return}
 if(entryIntent==='enrichment'){if(core.setType)core.setType(s,'خطة');if(core.setSubtype)core.setSubtype(s,'خطة إثرائية');s.metadata.directEntry134='enrichment';return}
}

/* Analysis Output V2.3 — premium one-page print renderer for classroom grade analysis */
(function(){
  ...
  function schoolText(){
    ...
    const t=paper?.querySelector('.schoolHead')?.innerText?.trim();return t||'';
  }
  ...
  function render(){
    ...
    const old=paper.querySelector('.v2FamilyBody');if(!old)return;
    const d=data();
  ...
  window.GC_ANALYSIS_OUTPUT_V2={version:'2.3',render};
  ...
  const s=document.createElement('style');s.textContent=`
    ...
    .arSplit{display:grid;grid-template-columns:1.08fr .92fr;gap:10px;margin-bottom:10px}.arSplit>section{border:1px solid var(--line);border-radius:12px;padding:10px;background:#fff}
    ...
    @media(max-width:700px){.arMeta{grid-template-columns:repeat(2,1fr)}.arStats{grid-template-columns:repeat(3,1fr)}.arSplit,.arDecision{grid-template-columns:1fr}}
    @media print{
      body.gc-v2-printing #printDocument .analysisReportV2{font-size:10px!important}
      body.gc-v2-printing #printDocument .arMeta{grid-template-columns:repeat(4,1fr)!important;gap:4px!important;margin-bottom:5px!important}
      body.gc-v2-printing #printDocument .arMeta>div{padding:5px 6px!important;min-height:31px!important;border-radius:7px!important}
      body.gc-v2-printing #printDocument .arStats{grid-template-columns:repeat(6,1fr)!important;gap:4px!important;margin-bottom:6px!important}
      body.gc-v2-printing #printDocument .arStat{padding:5px 2px!important;border-radius:7px!important}.arStat b{font-size:13px!important}.arStat span{font-size:7.3px!important}
      body.gc-v2-printing #printDocument .arSplit{grid-template-columns:1.08fr .92fr!important;gap:6px!important;margin-bottom:6px!important}.arSplit>section{padding:6px!important;border-radius:8px!important}.analysisReportV2 h3{font-size:10px!important;margin-bottom:4px!important}
      body.gc-v2-printing #printDocument .arRow{min-height:19px!important}.arRow span{font-size:7.5px!important;padding:2px 4px!important}.arBars{gap:4px!important}.arTrack{height:7px!important}.arBarMeta b{font-size:7.5px!important}.arBarMeta span{font-size:6.8px!important}
      body.gc-v2-printing #printDocument .arInsight{padding:6px 8px!important;margin-bottom:5px!important;border-radius:8px!important}.arInsightTitle{margin-bottom:3px!important}.arInsightTitle span{font-size:9px!important}.arInsightTitle b{font-size:11px!important}.arInsight>p{font-size:7.8px!important;line-height:1.45!important;margin-bottom:4px!important}.arDecision{grid-template-columns:1fr 1fr!important;gap:4px!important}.arDecision>div{padding:4px!important;border-radius:6px!important}.arDecision span{font-size:6.7px!important}.arDecision p{font-size:7px!important;line-height:1.4!important}.arInsight>small{font-size:6px!important;margin-top:3px!important}
      body.gc-v2-printing #printDocument .arFootFacts{padding-top:4px!important}.arFootFacts span{font-size:6.8px!important}.arSigns{margin-top:5px!important;padding-top:4px!important;gap:35px!important}.arSigns>div{min-height:18px!important}.arSigns span,.arSigns b{font-size:7px!important}
    }

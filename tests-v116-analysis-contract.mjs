...
assert.equal(analysisCountConsistency116(state(3,[1,2,3])).status,'ok');
assert.equal(analysisCountConsistency116(state(5,[1,2,3])).diff,2);
assert.equal(analysisCountConsistency116(state(2,[1,2,3])).diff,1);
